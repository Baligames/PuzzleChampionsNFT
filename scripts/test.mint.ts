...
/*
deploying "ChampionChestNFTLogic" (tx: 0x20ab1103c3a5ba618a0d4290c17b89199c2da99e4351a3f7dba028f29eb9f950)...: deployed at 0x485f6f9B682844703490404783c349573190937C with 2841131 gas
deploying "ChampionChestNFT" (tx: 0x6f97ff749c078026242ff5ce535242013b37dd1ee5f70abf366e6ef5469d6666)...: deployed at 0x2c6Ff7e8b7A21D4BBE984b7c7666A627F12Fc656 with 938082 gas
verifying ChampionChestNFT (0x2c6Ff7e8b7A21D4BBE984b7c7666A627F12Fc656 on chain 2021) ...
 => contract ChampionChestNFT is now verified
verifying ChampionChestNFTLogic (0x485f6f9B682844703490404783c349573190937C on chain 2021) ...
...
async function main() {
    ...
    try {
      ...
      // mintLaunchpad 함수 호출
      const tx = await championChestNFT.mintLaunchpad(recipientAddress, 1, "0x", {gasLimit: manualGasLimit});
